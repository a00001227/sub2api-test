  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        usdtRechargeMultiplier: 'USDT 充值倍率',
        usdtRechargeMultiplierHint: '用户每支付 1 USDT 可获得多少余额（默认 1，即 1:1）',
        ...
        field_paymentCurrencyHint: '默认 CNY。Stripe 和 Airwallex 可按账户支持从下拉项选择 HKD、USD 等币种；易支付的微信/支付宝渠道保持 CNY，USDT 渠道请选 USD。',
