  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        name: '名称',
        slug: '通道标识（Slug）',
        slugPlaceholder: '例如 openai、cc-pro（可选）',
        slugHint:
          '小写字母、数字、连字符，1-64 位。设置后可通过 /{slug}/v1/... 直接访问该分组，留空则不启用',
        description: '描述',
        platform: '平台',
        rateMultiplier: '费率倍数',
        status: '状态',
    ...
    promptAudit: {
      title: '提示词审计',
      description: '留存用户提示词原文，供事后审计与取证（独立于风控中心）',
      loadFailed: '加载提示词审计失败',
      saveFailed: '保存配置失败',
      saved: '配置已保存',
      refresh: '刷新',
      config: '审计配置',
      configHint: '开启后按需留存用户提示词全文。异步落库，不影响请求与内容审核延迟。默认关闭。',
      enabled: '启用提示词审计',
      enabledHint: '关闭时零开销放行，不留存任何原文。',
      retentionDays: '保留天数',
      retentionHint: '超过保留天数的记录每日自动清理（1–3650 天）。',
      save: '保存配置',
      status: '运行状态',
      queue: '队列',
      stored: '已留存',
    ...
    riskControl: {
      ...
      provider: '云审厂商',
      providerHint: '选择云端内容安全服务商。OpenAI 兼容走 /v1/moderations；阿里云 / 腾讯云走各自内容安全接口，未填凭据时自动跳过（放行并记录）。',
      providerOpenAI: 'OpenAI 兼容',
      providerAliyun: '阿里云内容安全',
      providerTencent: '腾讯云文本审核',
      credConfigured: '已配置',
      credConfiguredKeep: '已配置（留空则保持不变）',
      credEnter: '请输入',
      vendorCredHint: '凭据仅在此保存，掩码显示；留空表示保持原值不变。区域 / 端点 / 服务等非敏感项可随时修改。',
      aliyunAccessKeyId: '阿里云 AccessKey ID',
      aliyunAccessKeySecret: '阿里云 AccessKey Secret',
      aliyunRegion: '区域 (RegionId)',
      aliyunEndpoint: '接入点 (Endpoint)',
      aliyunService: '检测服务 (Service)',
      tencentSecretId: '腾讯云 SecretId',
      tencentSecretKey: '腾讯云 SecretKey',
      tencentRegion: '区域 (Region)',
      tencentBizType: '策略编号 (BizType)',
      ...
      allowedHashes: '放行白名单（输入哈希）',
      allowedHashesPlaceholder: '每行一个输入哈希（sha256），从下方审核日志复制，例如：\n3b1f...（64 位小写十六进制）',
      allowedHashCount: '已放行 {count} 条',
      allowedHashesHint: '命中的输入在审核最前端直接放行——不走关键词/预哈希/LLM，也不再计入命中或收录哈希。适合放行「明确合规、但会被 LLM 反复判命中」的固定请求（按精确哈希匹配，请求文本需逐字一致）。',
      importSeedKeywords: '导入基础词库',
      importingKeywords: '导入中…',
      importKeywordsResult: '已导入基础词库，新增 {added} 个，共 {total} 个（记得点保存生效）。',
      importKeywordsFailed: '导入基础词库失败',
    ...
    feedbacks: {
      ...
      markPending: '标记未处理',
      replyLabel: '管理员回复',
      replyPlaceholder: '输入回复内容，提交后工单将标记为已处理…',
      submitReply: '提交回复',
      repliedAt: '回复时间',
      failedToLoad: '加载反馈失败',
      failedToUpdate: '更新状态失败',
      failedToReply: '提交回复失败',
      statusLabels: {
        pending: '未处理',
        resolved: '已处理',
      },
    ...
    settings: {
      ...
      scheduling: {
        ...
        subKeyPrefixRequired: '客户密钥强制通道前缀',
        subKeyPrefixRequiredHint:
          '开启后，客户密钥（sub key）必须通过带通道前缀的 URL（如 /openai/v1/...）显式选择通道，不带前缀的请求将被拒绝（403）。可防止客户配错 Base URL 时静默落到主通道计费。'
      },
      gatewayForwarding: {
        title: '请求转发行为',
      ...
      site: {
        ...
        customEndpoints: {
          title: '自定义端点',
          description: '添加额外的 API 端点地址，用户可在「API Keys」页面快速复制。名称和介绍支持中英双语：中文在前、英文在后，中间用竖线分隔；端点地址填原始 URL，不要加竖线。',
          itemLabel: '端点 #{n}',
          name: '名称',
          namePlaceholder: "中文名称 {'|'} English name",
          endpointUrl: '端点地址',
          endpointUrlPlaceholder: 'https://api2.example.com',
          descriptionLabel: '介绍',
          descriptionPlaceholder: "中文介绍 {'|'} English desc",
          add: '添加端点',
        },
        contactInfo: '客服联系方式',
        contactInfoPlaceholder: "Telegram群链接 {'|'} 邮箱 {'|'} Telegram客服 {'|'} WhatsApp",
        contactInfoHint: '4 段固定顺序、用竖线分隔：① Telegram 群链接 ② 邮箱 ③ Telegram 客服 ④ WhatsApp。某项没有就留空但保留竖线，第 5 段及以后会被忽略。展示在兑换页面、个人资料等位置。',
        docUrl: '文档链接',
      ...
      payment: {
        ...
        usdtRechargeMultiplier: '稳定币充值倍率（USDT / USDC）',
        usdtRechargeMultiplierHint: '用户每支付 1 USDT 或 1 USDC 可获得多少余额（默认 1，即 1:1），两种稳定币共用',
        ...
        field_paymentCurrencyHint: '默认 CNY。Stripe 和 Airwallex 可按账户支持从下拉项选择 HKD、USD 等币种；易支付的微信/支付宝渠道保持 CNY，USDT / USDC 渠道请选 USD。',
        ...
        field_usdtType: 'USDT 通道码',
        field_usdtTypeHint: '自建易支付面板的 USDT 通道码（即 type 参数）。默认为 “usdt”。',
        field_cidUsdc: 'USDC 渠道 ID',
        field_usdcType: 'USDC 通道码',
        field_usdcTypeHint: '自建易支付面板的 USDC 通道码（即 type 参数）。默认为 “usdc.solana”。',
    ...
    pricingDisplay: {
      title: '价格展示管理',
      description: '管理门户网站展示的模型定价，所有折扣计算均在服务端完成。',
      addModel: '添加模型',
      allTypes: '全部类型',
      allUserTypes: '全部用户类型',
      allStatus: '全部状态',
      typeText: '文本',
      typeImage: '图像',
      userTypeEndUser: '普通用户',
      userTypeChannelUser: '渠道用户',
      enabled: '已启用',
      disabled: '已禁用',
      colModel: '模型',
      colType: '类型',
      colUserType: '用户类型',
      colInputOutput: '输入 / 输出',
      colSaving: '优惠',
      colEnabled: '启用',
      colUpdated: '更新时间',
      colActions: '操作',
      ...
      delete: '删除',
      deleteTitle: '删除价格模型',
      deleteConfirm: '确定删除 {model}（{userType}）？此操作不可撤销。',
      cancel: '取消',
      deleting: '删除中...',
      deleteSuccess: '价格模型已删除',
      deleteFail: '删除失败',
      loadFail: '加载价格模型失败',
      toggleFail: '切换状态失败',
      modelEnabled: '模型已启用',
      modelDisabled: '模型已禁用',
      dialogCreateTitle: '添加价格模型',
      dialogEditTitle: '编辑价格模型',
      sectionModelInfo: '模型信息',
      labelModelName: '模型名称',
      labelType: '类型',
      labelUserType: '用户类型',
      labelEnabled: '启用',
      sectionTextPricing: '文本定价（每百万 tokens / $/MTok）',
      textPricingHint: '先填「官方价」，再填「你的价」或「折扣%」任一，另一个自动换算。单位均为 $/百万 tokens。',
      colOfficial: '官方价',
      colYourPrice: '你的价',
      colDiscount: '折扣',
      unitMtok: '单位：$/百万 tokens（后台按每 token 存储）',
      rowInput: '输入',
      rowOutput: '输出',
      rowCacheRead: '缓存读',
      rowCacheWrite: '缓存写',
      ...
      labelCacheWritePrice: '缓存写入价格',
      officialPricesTitle: '官方价格（用于计算折扣）',
      labelOfficialInput: '官方输入价',
      labelOfficialOutput: '官方输出价',
      labelOfficialCacheRead: '官方缓存读价',
      labelOfficialCacheWrite: '官方缓存写价',
      perFieldDiscount: '官方 {price} · 省 {pct}',
      sectionImagePricing: '图像定价',
      imagePricingHint: '添加分辨率标识（如 1k、2k、4k、ultra）及对应每张图片价格。',
      addResolution: '添加分辨率',
      labelSavingOverride: '优惠比例（可选覆盖）',
      savingOverrideHint: '例如输入 0.73 表示节省 73%，留空则为 0%。',
      btnSaveChanges: '保存修改',
      btnCreate: '创建模型',
      btnSaving: '保存中...',
      saveSuccess: '价格模型已更新',
      ...
      catalog: {
        ...
        platformAll: '全部',
        sync: '同步模型',
        syncSuccess: '已同步官方价格（共 {total} 个模型）',
        syncFail: '同步官方价格失败',
        searchPlaceholder: '搜索模型代号…',
        empty: '未找到匹配的模型。',
        added: '已添加',
        officialInline: '官方 输入 {input} · 输出 {output}',
        officialImageInline: '官方 单图 {price}',
        manualCreate: '手动创建',
        confirm: '确认添加（{count}）',
        adding: '添加中…',
        addResult: '已添加 {created} 个，跳过 {skipped} 个',
        addFail: '添加模型失败',
        loadFail: '加载官方目录失败',
      },
    },
    ...
    evidence: {
      ...
      threshold: '重复阈值',
      thresholdHint: '仅重复达此次数的提示才存原文',
      thresholdIs: '重复≥{n}次才存原文',
      badThreshold: '请输入 >=2 的阈值',
      repeatBadge: '重复 x{n}',
      timeSpan: '时间跨度',
      summary: '{n} 个重复模板，最高重复 {max} 次',
      noBodyYet: '尚未存原文（需重复 >= {n} 次）',
      dupBadge: '模板重复 x{n}',
      dupSummary: '{n} 条模板重复',
      ...
      start: '开始取证',
      capturing: '取证中',
      remaining: '剩余 {remaining} / {max}',
      view: '查看已抓',
      loading: '加载中…',
      purge: '停止并清除',
      entriesCount: '已捕获 {n} 条请求',
      empty: '尚未捕获到请求。',
      truncated: '已截断',
      started: '已开始取证',
      startFail: '开始取证失败',
      loadFail: '加载失败',
      badCount: '请输入有效条数（1-500）',
      purgeConfirm: '确认清除已捕获证据并停止对该用户取证？',
      purged: '证据已清除',
      purgeFail: '清除失败',
    },
    enforcement: {
      title: '执行层：HIGH 自动限速 + 人工封禁',
      on: '已启用',
      off: '未启用',
      expand: '展开',
      collapse: '收起',
      hint: '⚠ 默认关。开启后仅对 HIGH 且置信度达标的用户施加独立低 RPM 上限；豁免名单一票否决；封禁只走人工，可逆。阈值未校准，建议先小流量观察。',
      master: '总开关',
      throttleRpm: '限速 RPM',
      confidenceMin: '置信度地板',
      highCount: 'HIGH 用户数',
      allowlistSize: '豁免数',
      refreshedAt: '刷新时间',
      disabledNote: '执行层未启用，当前仅观测——不会对任何用户限速或封禁。可通过 ENFORCEMENT_ENABLED 打开。',
      refresh: '刷新',
      colUser: '用户',
      colRiskIndex: '风险指数',
      colConfidence: '置信度',
      colDataSufficient: '数据充分',
      colState: '状态',
      colActions: '操作',
      yes: '是',
      no: '否',
      stateThrottled: '限速中',
      stateAllowlisted: '已豁免',
      stateObserved: '仅观测',
      exempt: '豁免',
      unexempt: '取消豁免',
      banUser: '封禁用户',
      ...
      actionFail: '操作失败',
      modelsTitle: '受限模型',
      modelsHint: '仅对 HIGH（未豁免）用户生效：请求这些模型时按规则处置，其它模型放行。',
      modelLabel: '模型名',
      modelPlaceholder: '如 claude-opus-4',
      actionLabel: '动作',
      actBlock: '禁用',
      actThrottle: '限速',
      addRule: '添加',
    ...
    riskV2: {
      ...
      modeEnabledOnly: '已启用',
      modeAggOnly: '仅采集（不评分）',
      modeDryRun: 'Dry Run — 不保存风险结果',
      modePersist: '影子结果已保存',
      workerDegraded: 'Worker 降级',
      leader: '主节点',
      showDetails: '展开运行详情',
      hideDetails: '收起运行详情',
      stWorkerReady: 'Worker 就绪',
      stSchemaReady: 'Schema 就绪',
      stHealthAvail: '健康可用',
      stDropRatio: '丢弃比率',
      stQueueDepth: '队列深度',
      stCoverage: '健康覆盖率',
      ...
      stScoring: '评分',
      stPersist: '持久化',
      stDispatcher: 'Dispatcher 就绪',
      stReporter: 'Reporter 就绪',
      stCurrentCycle: '当前周期',
      stLastCycle: '最后完成周期',
      stLastCycleStatus: '最后周期状态',
      stLastError: '最后错误码',
      stUpdated: '最后更新',
      filterTier: '风险等级',
      filterMinIndex: '最小风险指数',
      filterUserId: '用户 ID',
      filterFreshness: '新鲜度',
      filterDataSufficient: '数据充分',
      filterDegraded: '降级',
      filterFrom: '评估起始',
      filterTo: '评估截止',
      allTiers: '全部等级',
      ...
      query: '查询',
      clearFilters: '清除',
      errIndexRange: '风险指数必须在 0 到 100 之间',
      errUserId: '用户 ID 必须为正整数',
      errTime: '时间无效',
      errFromAfterTo: '「起始」不得晚于「截止」',
      colUser: '用户',
      colTier: '等级',
      colIndex: '风险指数',
      colConfidence: '置信度',
      colData: '数据充分',
      colPlanes: '平面 (A/H/C/E)',
      colReasons: '主要原因',
      colFlags: '标志',
      colAssessed: '评估时间',
      unknownUser: '未知用户',
      highTooltip: '行为高度疑似 — 不代表已证明模型蒸馏。',
      flagDegraded: '降级',
      flagIncomplete: '不完整',
      flagHealthNA: '健康未知',
      flagTimeAnomaly: '时间异常',
      fresh: '新鲜',
      stale: '过期',
      schemaNotReadyTitle: 'Schema 未就绪',
      schemaNotReadyDesc: 'user_risk_v2 表不可用。请开启持久化并应用迁移。',
      emptyTitle: '暂无评估',
      emptyDesc: '尚未保存任何影子评估结果。',
      pageSize: '每页',
      pageLabel: '第 {page} 页',
      prev: '上一页',
      next: '下一页',
      ...
      reasonsSection: '原因码',
      liveSection: '实时窗口',
      liveNoData: '该用户暂无近期数据。',
      liveUnavailable: '实时指标不可用。',
      liveRateLimited: '实时指标触发限流，请稍后重试。',
      liveBusy: '实时指标繁忙，请稍后重试。',
      winRequests: '请求数',
      winActiveMin: '活跃分钟',
      winOutTokens: '输出 Token',
      winDistinctScaffold: '去重脚手架',
      mkActiveKeys: '24h 活跃 Key',
      mkSync: '1h 同步分钟',
      mkOverlap: '1h 脚手架重叠',
      mkHandoff: '1h Key 交接',
      detailNotFound: '未找到评估',
      detailFail: '加载评估详情失败',
      loadFail: '加载用户失败',
      viewDetail: '详情',
      colActions: '操作',
      metHigh: '达到 HIGH',
      familiesSection: '证据家族',
      incompleteSection: '数据不完整原因',
      reasonWindow: '窗口',
      reasonObserved: '观测值',
      reasonThreshold: '阈值',
      reasonFamily: '家族',
      reasonGroup: '分组',
      reasonConfidence: '置信度贡献',
      dryRunEmptyTitle: 'Dry Run —— 结果未持久化',
      dryRunEmptyDesc: '当前为 Dry Run，风险结果尚未持久化。这并不表示所有用户都是低风险。',
      errUnauthorized: '登录状态已过期，请重新登录。',
      errForbidden: '你没有查看 Risk V2 的权限。',
      errRateLimited: '请求过于频繁，请稍后再试。',
      errBusy: '服务繁忙，请稍后再试。',
      errServer: '加载评估时服务器出错。',
      errUnavailable: 'Risk V2 暂时不可用。',
      loadingLabel: '加载中',
      ariaRefresh: '刷新运行状态与评估列表',
      ariaClose: '关闭评估详情面板',
      ariaViewDetail: '查看 {user} 的评估详情',
      ariaLoadLive: '按需加载实时窗口指标',
      liveHint: '实时指标仅在你点击时按需拉取——不会自动加载，也不会轮询。',
      liveLoadBtn: '加载实时窗口',
      liveReload: '重新加载',
      liveLoadingLabel: '加载中…',
      liveCooldown: '请等待 {sec} 秒',
      liveCacheNote: 'Cache / 会话连续性当前不影响 Risk Tier。',
      liveNearDupNote: 'Near Duplicate（近重复）信号当前不可用。',
      reason: {
        EXACT_DUPLICATION_HIGH: '精确重复提示词偏高',
        FULL_SCAFFOLD_REUSE_HIGH: '完整脚手架复用偏高',
        SCAFFOLD_EXPANSION_HIGH: '脚手架扩展偏高',
        REPEATED_SAMPLING_HIGH: '重复采样偏高',
        REQUEST_BURST_HIGH: '请求突发偏高',
        REQUEST_ACCELERATION_HIGH: '请求加速偏高',
        OUTPUT_COLLECTION_HIGH: '输出采集偏高',
        SHORT_OUTPUT_HIGH_FREQUENCY: '短输出高频',
        MULTI_KEY_SYNCHRONIZED: '多 Key 同步活动',
        CROSS_KEY_SCAFFOLD_OVERLAP: '跨 Key 脚手架重叠',
        KEY_HANDOFF_DETECTED: '检测到 API Key 交接',
        MULTI_KEY_COORDINATION_HIGH: '多 Key 协同偏高',
        SAMPLED_INPUT_RATIO_HIGH: '采样输入比例偏高（降低置信度）',
        TRUNCATED_INPUT_RATIO_HIGH: '截断输入比例偏高（降低置信度）',
        FEATURE_COVERAGE_LOW: '特征覆盖率偏低（降低置信度）',
        DATA_INSUFFICIENT: '数据不足',
        RISK_V2_DEGRADED: '评估降级',
        RISK_V2_CONFIG_INVALID: '评分配置无效',
      },
      family: {
        TEMPLATE_ENUMERATION: '模板枚举',
        TEMPORAL_AUTOMATION: '时间自动化',
        OUTPUT_COLLECTION: '输出采集',
        REPEATED_SAMPLING: '重复采样',
        MULTI_KEY_COORDINATION: '多 Key 协同',
        CACHE_SESSION_CONTINUITY: 'Cache / 会话连续性',
        MODEL_CONCENTRATION: '模型集中度',
      },
      group: {
        PROMPT_PATTERN: '提示词模式',
        TEMPORAL_INTENSITY: '时间强度',
        RESPONSE_HARVEST: '响应采集',
        COORDINATION: '协同',
        MODEL: '模型',
      },
      incomplete: {
        exact_incomplete: '精确重复估计不完整',
        full_scaffold_incomplete: '完整脚手架估计不完整',
        sampled_scaffold_incomplete: '采样脚手架估计不完整',
        apikey_overflow: 'API Key 数量溢出（采样）',
        multikey_incomplete: '多 Key 汇总不完整',
        redis_degraded: '聚合存储降级',
      },
      apiError: {
        RISK_V2_SCHEMA_NOT_READY: 'Schema 未就绪',
        RISK_V2_ASSESSMENT_NOT_FOUND: '未找到评估',
        RISK_V2_LIVE_METRICS_RATE_LIMITED: '实时指标刷新过于频繁，请稍后再试。',
        RISK_V2_LIVE_METRICS_BUSY: '实时指标服务繁忙，请稍后再试。',
        RISK_V2_LIVE_METRICS_UNAVAILABLE: '实时指标暂不可用。',
        RISK_V2_DEGRADED: '评估已降级。',
        RISK_V2_BAD_REQUEST: '请求无效。',
        RISK_V2_INTERNAL: '内部错误。',
      },
      tier: {
