    ...
    settings: {
      ...
      site: {
        ...
        customEndpoints: {
          ...
          description: 'Add additional API endpoint URLs for users to quickly copy on the API Keys page. Name/Description support bilingual "中文 | English" (split by |, Chinese first then English, shown per UI locale); Endpoint URL must be the raw URL — do not add |.',
          itemLabel: 'Endpoint #{n}',
          name: 'Name',
          namePlaceholder: '中文名称 | English name (e.g., OpenAI 兼容 | OpenAI Compatible)',
          endpointUrl: 'Endpoint URL',
          endpointUrlPlaceholder: 'https://api2.example.com',
          descriptionLabel: 'Description',
          descriptionPlaceholder: '中文介绍 | English desc (e.g., 支持 OpenAI 格式 | OpenAI-compatible)',
          add: 'Add Endpoint',
        },
        contactInfo: 'Contact Info',
        contactInfoPlaceholder: 'Telegram group link | Email | Telegram | WhatsApp',
        contactInfoHint: '4 fixed slots split by | : ① Telegram group link ② Email ③ Telegram ④ WhatsApp. Leave a slot empty but keep the | (e.g. "| a@b.com | @cs |"); a 5th+ segment is ignored. Shown on redeem page, profile, etc.',
