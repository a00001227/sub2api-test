  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        usdtRechargeMultiplier: 'USDT Recharge Multiplier',
        usdtRechargeMultiplierHint: 'How much balance the user receives per 1 USDT paid (default 1 = 1:1)',
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe and Airwallex can choose HKD, USD, or another listed currency supported by the account. For EasyPay, keep CNY for WeChat Pay / Alipay channels and choose USD for a USDT channel.',
