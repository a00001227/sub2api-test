export default {
  ...
  admin: {
    ...
    risk: {
      title: 'Risk Monitor',
      description: 'Anti-distillation shadow dashboard: observe scoring and features for high-risk users. Nothing is blocked in this phase.',
      refresh: 'Refresh',
      loadFail: 'Failed to load risk data',
      // Shadow-mode banner
      shadowBannerTitle: 'Shadow mode — observe only, no requests are blocked',
      shadowBannerDesc: 'Phase 0 observe-only. Scores and "would-do" actions are informational and do not affect any user.',
      enforceBannerTitle: 'Enforce mode is ON — actions run against real requests',
      enforceBannerDesc: 'Risk actions are live and affect real user traffic. Proceed with caution.',
      ...
      colScore: 'Score',
      colTier: 'Tier',
      colFeatures: 'Key features',
      colWouldDo: 'Would do (if enforced)',
      colAllowlist: 'Allowlist',
      colManualTier: 'Manual tier',
      featDistinctRatio: 'Distinct ratio',
      featSingleTurn: 'Single-turn ratio',
      featOutIn: 'Out/In',
      featTopModel: 'Top model',
      featRpmPeak: 'RPM peak',
      featBudgetPct: 'Budget %',
      wouldThrottle: 'Throttle & flag',
      wouldMonitor: 'Monitor closely',
      wouldNone: 'None',
      manualAuto: 'Auto',
      manualTierUpdated: 'Manual tier updated',
      manualTierFail: 'Failed to update manual tier',
      allowlistOn: 'Added to allowlist',
      allowlistOff: 'Removed from allowlist',
      allowlistFail: 'Failed to update allowlist',
      // Empty state
      emptyTitle: 'No scored users yet',
      emptyDesc: 'No scoring data yet — the worker aggregates every ~5 minutes.',
      // Row detail
      detailTitle: 'User risk detail',
      close: 'Close',
      featuresSection: 'Feature vector (f1–f7)',
      windowSection: '24h window',
      f1: 'f1 Diversity collapse',
      f2: 'f2 Single-turn ratio',
      f3: 'f3 Output harvest',
      f4: 'f4 Machine cadence',
      f5: 'f5 Teacher concentration',
      f6: 'f6 Determinism',
      f7: 'f7 Fanout novelty',
      winRequests: 'Requests',
      winOutputTokens: 'Output tokens',
      winDistinctRatio: 'Distinct ratio',
      winSingleTurn: 'Single-turn ratio',
      winTopModel: 'Top model',
      winRpmPeak: 'RPM peak',
      winBudgetPct: 'Budget %',
      detailLoadFail: 'Failed to load user detail',
      // Config panel
      configTitle: 'Risk config',
      configHint: 'Phase 0 config is in-memory and resets to defaults on restart.',
      configMode: 'Mode',
      configModeObserveOpt: 'Observe',
      configModeEnforceOpt: 'Enforce',
      enforceWarning: '⚠ Switching to "Enforce" turns on real enforcement actions that affect live users. Keep "Observe" by default.',
      mediumScore: 'Medium score threshold',
      highScore: 'High score threshold',
      volumeFloor: 'Volume floor',
      andGateK: 'AND-gate K',
      dailyBudget: 'Daily budget (USDC)',
      weeklyBudget: 'Weekly budget (USDC)',
      weightsSection: 'Feature weights (f1–f7)',
      thresholdsSection: 'Feature thresholds (f1–f7)',
      save: 'Save config',
      saving: 'Saving...',
      saveSuccess: 'Risk config saved',
      saveFail: 'Failed to save risk config',
      configLoadFail: 'Failed to load risk config',
      expand: 'Expand',
      collapse: 'Collapse',
    }
  },
