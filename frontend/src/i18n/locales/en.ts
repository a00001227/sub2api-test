  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        name: 'Name',
        slug: 'Channel Slug',
        slugPlaceholder: 'e.g. openai, cc-pro (optional)',
        slugHint:
          'Lowercase letters, digits, hyphens, 1-64 chars. When set, the group is reachable via /{slug}/v1/...; leave empty to disable',
        description: 'Description',
        platform: 'Platform',
        rateMultiplier: 'Rate Multiplier',
        status: 'Status',
    ...
    promptAudit: {
      title: 'Prompt Audit',
      description: 'Retain full user prompts for later audit and forensics (independent of Risk Control)',
      loadFailed: 'Failed to load prompt audit',
      saveFailed: 'Failed to save config',
      saved: 'Config saved',
      refresh: 'Refresh',
      config: 'Audit Config',
      configHint: 'When enabled, retains full user prompts. Persisted asynchronously with no impact on request or moderation latency. Off by default.',
      enabled: 'Enable Prompt Audit',
      enabledHint: 'When off, requests pass through with zero overhead and nothing is retained.',
      retentionDays: 'Retention Days',
      retentionHint: 'Records older than the retention window are purged daily (1-3650 days).',
      save: 'Save Config',
    ...
    riskControl: {
      ...
      providerHint: 'Choose the cloud content-safety provider. OpenAI-compatible uses /v1/moderations; Aliyun / Tencent use their own content-safety APIs and are skipped (allow + log) when credentials are empty.',
      providerOpenAI: 'OpenAI-compatible',
      providerAliyun: 'Aliyun Content Safety',
      providerTencent: 'Tencent Text Moderation',
      credConfigured: 'Configured',
      credConfiguredKeep: 'Configured (leave blank to keep)',
      credEnter: 'Enter value',
      vendorCredHint: 'Credentials are stored here and shown masked; leave blank to keep the current value. Region / endpoint / service are non-sensitive and editable anytime.',
      aliyunAccessKeyId: 'Aliyun AccessKey ID',
      aliyunAccessKeySecret: 'Aliyun AccessKey Secret',
      aliyunRegion: 'Region (RegionId)',
      ...
      allowedHashes: 'Allowlist (input hashes)',
      allowedHashesPlaceholder: 'One input hash (sha256) per line, copied from the audit log below, e.g.:\n3b1f... (64-char lowercase hex)',
      allowedHashCount: '{count} allowed',
      allowedHashesHint: 'A matching input is allowed at the very front of moderation — skipping keyword/pre-hash/LLM checks, and never counted as a hit or recorded as a hash. Use it for fixed requests that are clearly compliant but keep getting flagged by the LLM (exact-hash match; the request text must be byte-identical).',
      importSeedKeywords: 'Import base list',
      importingKeywords: 'Importing…',
      importKeywordsResult: 'Base keyword list imported: {added} added, {total} total (remember to Save).',
      importKeywordsFailed: 'Failed to import base keyword list',
    ...
    feedbacks: {
      title: 'Feedback',
      description: 'View and handle user-submitted feedback',
      allStatus: 'All status',
      ...
      replyPlaceholder: 'Enter your reply. Submitting will mark the ticket as resolved…',
      submitReply: 'Submit reply',
      repliedAt: 'Replied at',
      failedToLoad: 'Failed to load feedback',
      failedToUpdate: 'Failed to update status',
      failedToReply: 'Failed to submit reply',
      statusLabels: {
        pending: 'Pending',
        resolved: 'Resolved',
      },
    ...
    settings: {
      ...
      scheduling: {
        ...
        subKeyPrefixRequired: 'Require Channel Prefix for Client Keys',
        subKeyPrefixRequiredHint:
          'When enabled, client keys (sub keys) must select a channel via a URL prefix (e.g. /openai/v1/...); requests without a prefix are rejected (403). Prevents misconfigured base URLs from silently billing on the main channel.'
      },
      gatewayForwarding: {
      ...
      site: {
        ...
        customEndpoints: {
          ...
          description: 'Add additional API endpoint URLs for users to quickly copy on the API Keys page. Name and Description support bilingual text: Chinese first, English second, separated by a vertical bar; Endpoint URL must be the raw URL without a vertical bar.',
          itemLabel: 'Endpoint #{n}',
          name: 'Name',
          namePlaceholder: "Chinese name {'|'} English name",
          endpointUrl: 'Endpoint URL',
          endpointUrlPlaceholder: 'https://api2.example.com',
          descriptionLabel: 'Description',
          descriptionPlaceholder: "Chinese desc {'|'} English desc",
          add: 'Add Endpoint',
        },
        contactInfo: 'Contact Info',
        contactInfoPlaceholder: "Telegram group {'|'} Email {'|'} Telegram {'|'} WhatsApp",
        contactInfoHint: '4 fixed slots separated by a vertical bar: (1) Telegram group link (2) Email (3) Telegram (4) WhatsApp. Leave a slot empty but keep the bar; a 5th+ segment is ignored. Shown on redeem page, profile, etc.',
      ...
      payment: {
        ...
        usdtRechargeMultiplier: 'Stablecoin Recharge Multiplier (USDT / USDC)',
        usdtRechargeMultiplierHint: 'How much balance the user receives per 1 USDT or 1 USDC paid (default 1 = 1:1); shared by both stablecoins',
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe and Airwallex can choose HKD, USD, or another listed currency supported by the account. For EasyPay, keep CNY for WeChat Pay / Alipay channels and choose USD for USDT / USDC channels.',
        ...
        field_usdtType: 'USDT Channel Code',
        field_usdtTypeHint: 'The USDT channel code used by your self-hosted EasyPay panel (the "type" parameter). Defaults to "usdt".',
        field_cidUsdc: 'USDC Channel ID',
        field_usdcType: 'USDC Channel Code',
        field_usdcTypeHint: 'The USDC channel code used by your self-hosted EasyPay panel (the "type" parameter). Defaults to "usdc.solana".',
    ...
    pricingDisplay: {
      ...
      description: 'Manage model pricing displayed in the portal. All savings calculations are done server-side.',
      addModel: 'Add Model',
      allTypes: 'All Types',
      ...
      userTypeChannelUser: 'Channel User',
      enabled: 'Enabled',
      disabled: 'Disabled',
      colModel: 'Model',
      colType: 'Type',
      colUserType: 'User Type',
      colInputOutput: 'Input / Output',
      colSaving: 'Saving',
      colEnabled: 'Enabled',
      colUpdated: 'Updated',
      colActions: 'Actions',
      resolutions: '{n} resolutions',
      noModels: 'No pricing models found.',
      edit: 'Edit',
      delete: 'Delete',
      deleteTitle: 'Delete Pricing Model',
      deleteConfirm: 'Delete {model} ({userType})? This cannot be undone.',
      cancel: 'Cancel',
      deleting: 'Deleting...',
      deleteSuccess: 'Pricing model deleted',
      deleteFail: 'Failed to delete',
      loadFail: 'Failed to load pricing models',
      toggleFail: 'Failed to toggle',
      modelEnabled: 'Model enabled',
      modelDisabled: 'Model disabled',
      dialogCreateTitle: 'Add Pricing Model',
      dialogEditTitle: 'Edit Pricing Model',
      sectionModelInfo: 'Model Info',
      labelModelName: 'Model Name',
      labelType: 'Type',
      labelUserType: 'User Type',
      labelEnabled: 'Enabled',
      sectionTextPricing: 'Text Pricing (per 1M tokens / $/MTok)',
      textPricingHint: 'Set the official price first, then enter either your price or a discount% — the other is computed automatically. All values in $/1M tokens.',
      colOfficial: 'Official',
      colYourPrice: 'Your price',
      colDiscount: 'Discount',
      unitMtok: 'Unit: $/1M tokens (stored per-token in the backend)',
      rowInput: 'Input',
      rowOutput: 'Output',
      ...
      labelCacheWritePrice: 'Cache Write Price',
      officialPricesTitle: 'Official Prices (for savings calculation)',
      labelOfficialInput: 'Official Input',
      labelOfficialOutput: 'Official Output',
      labelOfficialCacheRead: 'Official Cache Read',
      labelOfficialCacheWrite: 'Official Cache Write',
      perFieldDiscount: 'Official {price} · save {pct}',
      sectionImagePricing: 'Image Pricing',
      imagePricingHint: 'Add resolution keys (e.g. 1k, 2k, 4k, ultra) and their price per image.',
      addResolution: 'Add Resolution',
      labelSavingOverride: 'Saving % (optional override)',
      savingOverrideHint: 'e.g. enter 0.73 for 73% savings. Leave empty for 0%.',
      btnSaveChanges: 'Save Changes',
      btnCreate: 'Create Model',
      btnSaving: 'Saving...',
      ...
      catalog: {
        ...
        platformAll: 'All',
        sync: 'Sync Models',
        syncSuccess: 'Official prices synced ({total} models)',
        syncFail: 'Failed to sync official prices',
        searchPlaceholder: 'Search model code…',
        empty: 'No matching models found.',
        added: 'Added',
        officialInline: 'Official in {input} · out {output}',
        officialImageInline: 'Official per image {price}',
        manualCreate: 'Manual Create',
        confirm: 'Add Selected ({count})',
        adding: 'Adding…',
        addResult: 'Added {created}, skipped {skipped}',
        addFail: 'Failed to add models',
        loadFail: 'Failed to load official catalog',
      },
    },
    ...
    evidence: {
      ...
      thresholdHint: 'Only prompts repeated at least this many times are stored',
      thresholdIs: 'store at ≥{n} repeats',
      badThreshold: 'Enter a threshold >= 2',
      repeatBadge: 'Repeat x{n}',
      timeSpan: 'span',
      summary: '{n} repeated template(s), max repeat {max}',
      noBodyYet: 'content not stored yet (needs >= {n} repeats)',
      ...
      loading: 'Loading…',
      purge: 'Stop & purge',
      entriesCount: '{n} captured request(s)',
      empty: 'No requests captured yet.',
      truncated: 'truncated',
      started: 'Capture started',
      startFail: 'Failed to start capture',
      loadFail: 'Failed to load',
      badCount: 'Enter a valid count (1-500)',
      purgeConfirm: 'Purge captured evidence and stop capturing this user?',
      purged: 'Evidence purged',
      purgeFail: 'Failed to purge',
    },
    enforcement: {
      title: 'Enforcement: HIGH auto-throttle + manual ban',
      on: 'Enabled',
      off: 'Disabled',
      expand: 'Expand',
      collapse: 'Collapse',
      hint: '⚠ Default-off. When on, applies a separate low RPM cap only to HIGH users above the confidence floor; the allowlist overrides; bans are manual and reversible. Thresholds are uncalibrated — start with low traffic.',
      master: 'Master switch',
      throttleRpm: 'Throttle RPM',
      confidenceMin: 'Confidence floor',
      highCount: 'HIGH users',
      allowlistSize: 'Allowlisted',
      refreshedAt: 'Refreshed',
      disabledNote: 'Enforcement is off — observe-only; no user is throttled or banned. Turn on via ENFORCEMENT_ENABLED.',
      refresh: 'Refresh',
      colUser: 'User',
      colRiskIndex: 'Risk index',
      colConfidence: 'Confidence',
      colDataSufficient: 'Data sufficient',
      colState: 'State',
      colActions: 'Actions',
      yes: 'Yes',
      no: 'No',
      ...
      keyIdLabel: 'API key ID',
      keyIdPlaceholder: 'api_key_id',
      empty: 'No HIGH users currently.',
      exempted: 'Added to allowlist',
      ...
      modelsTitle: 'Restricted models',
      modelsHint: 'Applies only to HIGH (non-allowlisted) users: requests to these models are handled per rule; other models pass.',
      modelLabel: 'Model',
      modelPlaceholder: 'e.g. claude-opus-4',
      actionLabel: 'Action',
      actBlock: 'Block',
      actThrottle: 'Throttle',
      addRule: 'Add',
      removeRule: 'Remove rule',
      noRules: 'No restricted models.',
    ...
    riskV2: {
      ...
      shadowBannerTitle: 'Risk V2 · Shadow Only',
      shadowBadge: 'Shadow',
      ...
      modeAggOnly: 'Aggregation only (no scoring)',
      modeDryRun: 'Dry Run — risk results are NOT saved',
      modePersist: 'Shadow results are saved',
      workerDegraded: 'Worker degraded',
      leader: 'Leader',
      showDetails: 'Show runtime details',
      hideDetails: 'Hide runtime details',
      stWorkerReady: 'Worker Ready',
      stSchemaReady: 'Schema Ready',
      stHealthAvail: 'Health Available',
      stDropRatio: 'Drop Ratio',
      stQueueDepth: 'Queue Depth',
      stCoverage: 'Health Coverage',
      stAggregation: 'Aggregation',
      stScoring: 'Scoring',
      stPersist: 'Persist',
      stDispatcher: 'Dispatcher Ready',
      stReporter: 'Reporter Ready',
      stCurrentCycle: 'Current Cycle',
      stLastCycle: 'Last Completed Cycle',
      stLastCycleStatus: 'Last Cycle Status',
      stLastError: 'Last Error Code',
      stUpdated: 'Last Updated',
      filterTier: 'Tier',
      filterMinIndex: 'Min Risk Index',
      filterUserId: 'User ID',
      filterFreshness: 'Freshness',
      filterDataSufficient: 'Data Sufficient',
      filterDegraded: 'Degraded',
      filterFrom: 'Assessed From',
      filterTo: 'Assessed To',
      allTiers: 'All tiers',
      any: 'Any',
      yes: 'Yes',
      no: 'No',
      ...
      query: 'Query',
      clearFilters: 'Clear',
      errIndexRange: 'Risk index must be between 0 and 100',
      errUserId: 'User ID must be a positive integer',
      errTime: 'Invalid time',
      errFromAfterTo: '"From" must not be later than "To"',
      colUser: 'User',
      colTier: 'Tier',
      colIndex: 'Risk Index',
      colConfidence: 'Confidence',
      colData: 'Data Sufficient',
      colPlanes: 'Planes (A/H/C/E)',
      colReasons: 'Top Reasons',
      colFlags: 'Flags',
      colAssessed: 'Assessed',
      unknownUser: 'Unknown user',
      highTooltip: 'Highly suspected behavior — does NOT prove model distillation.',
      flagDegraded: 'degraded',
      flagIncomplete: 'incomplete',
      flagHealthNA: 'health n/a',
      flagTimeAnomaly: 'time anomaly',
      fresh: 'Fresh',
      stale: 'Stale',
      schemaNotReadyTitle: 'Schema Not Ready',
      schemaNotReadyDesc: 'The user_risk_v2 table is not available. Enable persistence and apply the migration.',
      emptyTitle: 'No assessments',
      emptyDesc: 'No shadow assessments have been saved yet.',
      pageSize: 'Page size',
      pageLabel: 'Page {page}',
      prev: 'Prev',
      next: 'Next',
      ...
      planesSection: 'Risk Planes',
      planeAutomation: 'Automation',
      planeHarvest: 'Harvest',
      planeCampaign: 'Campaign',
      planeExposure: 'Exposure',
      groupsSection: 'Evidence Groups',
      reasonsSection: 'Reason Codes',
      liveSection: 'Live Windows (real-time)',
      liveNoData: 'No recent data for this user.',
      liveUnavailable: 'Live metrics unavailable.',
      liveRateLimited: 'Live metrics rate limit exceeded, try again shortly.',
      liveBusy: 'Live metrics busy, try again shortly.',
      winRequests: 'Requests',
      winActiveMin: 'Active Minutes',
      winOutTokens: 'Output Tokens',
      winDistinctScaffold: 'Distinct Scaffolds',
      mkActiveKeys: 'Active Keys 24h',
      mkSync: 'Sync Minutes 1h',
      mkOverlap: 'Scaffold Overlap 1h',
      mkHandoff: 'Key Handoff 1h',
      detailNotFound: 'Assessment not found',
      detailFail: 'Failed to load assessment detail',
      loadFail: 'Failed to load users',
      viewDetail: 'Detail',
      colActions: 'Actions',
      metHigh: 'meets HIGH',
      familiesSection: 'Evidence Families',
      incompleteSection: 'Incomplete Reasons',
      reasonWindow: 'Window',
      reasonObserved: 'Observed',
      reasonThreshold: 'Threshold',
      reasonFamily: 'Family',
      reasonGroup: 'Group',
      reasonConfidence: 'Confidence contribution',
      dryRunEmptyTitle: 'Dry Run — results not persisted',
      dryRunEmptyDesc: 'Risk V2 is running in Dry Run; risk results are not persisted yet. This is NOT a statement that all users are low risk.',
      errUnauthorized: 'Your session has expired. Please sign in again.',
      errForbidden: 'You do not have permission to view Risk V2.',
      errRateLimited: 'Too many requests. Please try again shortly.',
      errBusy: 'The service is busy. Please try again shortly.',
      errServer: 'Server error while loading assessments.',
      errUnavailable: 'Risk V2 is temporarily unavailable.',
      loadingLabel: 'Loading',
      ariaRefresh: 'Refresh runtime status and assessment list',
      ariaClose: 'Close assessment detail panel',
      ariaViewDetail: 'View assessment detail for {user}',
      ariaLoadLive: 'Load live window metrics on demand',
      liveHint: 'Live metrics are fetched only on demand — they are not loaded automatically and are not polled.',
      liveLoadBtn: 'Load live windows',
      liveReload: 'Reload',
      liveLoadingLabel: 'Loading…',
      liveCooldown: 'Wait {sec}s',
      liveCacheNote: 'Cache / session continuity does not currently affect Risk Tier.',
      liveNearDupNote: 'Near-duplicate signal is currently unavailable.',
      reason: {
        EXACT_DUPLICATION_HIGH: 'High exact-duplicate prompts',
        FULL_SCAFFOLD_REUSE_HIGH: 'High full-scaffold reuse',
        SCAFFOLD_EXPANSION_HIGH: 'High scaffold expansion',
        REPEATED_SAMPLING_HIGH: 'High repeated sampling',
        REQUEST_BURST_HIGH: 'High request burst',
        REQUEST_ACCELERATION_HIGH: 'High request acceleration',
        OUTPUT_COLLECTION_HIGH: 'High output collection',
        SHORT_OUTPUT_HIGH_FREQUENCY: 'Frequent short outputs',
        MULTI_KEY_SYNCHRONIZED: 'Synchronized multi-key activity',
        CROSS_KEY_SCAFFOLD_OVERLAP: 'Cross-key scaffold overlap',
        KEY_HANDOFF_DETECTED: 'API key handoff detected',
        MULTI_KEY_COORDINATION_HIGH: 'High multi-key coordination',
        SAMPLED_INPUT_RATIO_HIGH: 'High sampled-input ratio (lowers confidence)',
        TRUNCATED_INPUT_RATIO_HIGH: 'High truncated-input ratio (lowers confidence)',
        FEATURE_COVERAGE_LOW: 'Low feature coverage (lowers confidence)',
        DATA_INSUFFICIENT: 'Insufficient data',
        RISK_V2_DEGRADED: 'Assessment degraded',
        RISK_V2_CONFIG_INVALID: 'Invalid scoring configuration',
      },
      family: {
        TEMPLATE_ENUMERATION: 'Template enumeration',
        TEMPORAL_AUTOMATION: 'Temporal automation',
        OUTPUT_COLLECTION: 'Output collection',
        REPEATED_SAMPLING: 'Repeated sampling',
        MULTI_KEY_COORDINATION: 'Multi-key coordination',
        CACHE_SESSION_CONTINUITY: 'Cache / session continuity',
        MODEL_CONCENTRATION: 'Model concentration',
      },
      group: {
        PROMPT_PATTERN: 'Prompt pattern',
        TEMPORAL_INTENSITY: 'Temporal intensity',
        RESPONSE_HARVEST: 'Response harvest',
        COORDINATION: 'Coordination',
        MODEL: 'Model',
      },
      incomplete: {
        exact_incomplete: 'Exact-duplicate estimate incomplete',
        full_scaffold_incomplete: 'Full-scaffold estimate incomplete',
        sampled_scaffold_incomplete: 'Sampled-scaffold estimate incomplete',
        apikey_overflow: 'API key count overflowed (sampled)',
        multikey_incomplete: 'Multi-key rollup incomplete',
        redis_degraded: 'Aggregation store degraded',
      },
      apiError: {
        RISK_V2_SCHEMA_NOT_READY: 'Schema not ready',
        RISK_V2_ASSESSMENT_NOT_FOUND: 'Assessment not found',
        RISK_V2_LIVE_METRICS_RATE_LIMITED: 'Live metrics rate limit exceeded, try again shortly.',
        RISK_V2_LIVE_METRICS_BUSY: 'Live metrics busy, try again shortly.',
        RISK_V2_LIVE_METRICS_UNAVAILABLE: 'Live metrics unavailable.',
        RISK_V2_DEGRADED: 'Assessment degraded.',
        RISK_V2_BAD_REQUEST: 'Invalid request.',
        RISK_V2_INTERNAL: 'Internal error.',
      },
      tier: {
