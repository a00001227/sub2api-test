...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		SubKeyChannelPrefixRequired:            settings.SubKeyChannelPrefixRequired,
		...
		PaymentUSDTRechargeMultiplier:          paymentCfg.USDTRechargeMultiplier,
...
type UpdateSettingsRequest struct {
	...
	PaymentUSDTRechargeMultiplier    *float64 `json:"payment_usdt_recharge_multiplier"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		SubKeyChannelPrefixRequired:            req.SubKeyChannelPrefixRequired,
	...
	if h.paymentConfigService != nil && hasPaymentFields(req) {
		paymentReq := service.UpdatePaymentConfigRequest{
			...
			USDTRechargeMultiplier:    req.PaymentUSDTRechargeMultiplier,
	...
	payload := dto.SystemSettings{
		...
		SubKeyChannelPrefixRequired:            updatedSettings.SubKeyChannelPrefixRequired,
		...
		PaymentUSDTRechargeMultiplier:          updatedPaymentCfg.USDTRechargeMultiplier,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentBalanceRechargeMultiplier != nil || req.PaymentUSDTRechargeMultiplier != nil || req.PaymentRechargeFeeRate != nil ||
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.SubKeyChannelPrefixRequired != after.SubKeyChannelPrefixRequired {
		changed = append(changed, "sub_key_channel_prefix_required")
	}
