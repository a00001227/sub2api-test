...
func (s *userRPMCacheStub) IncrementUserPlatformRPM(ctx context.Context, userID int64, _ string) (int, error) {
	return s.IncrementUserRPM(ctx, userID)
}

func (s *userRPMCacheStub) GetUserPlatformRPM(_ context.Context, _ int64, _ string) (int, error) {
	return 0, nil
}
