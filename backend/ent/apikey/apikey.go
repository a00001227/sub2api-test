...
// ByParentKeyID orders the results by the parent_key_id field.
func ByParentKeyID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldParentKeyID, opts...).ToFunc()
}
