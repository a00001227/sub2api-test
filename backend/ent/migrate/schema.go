...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "display_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "lane", Type: field.TypeString, Size: 20, Default: "normal"},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
	...
	UserPlatformQuotasColumns = []*schema.Column{
		...
		{Name: "concurrency", Type: field.TypeInt, Nullable: true},
