...
type Account struct {
	...
	// Provider Portal account reference (pa_<uuid>); NULL for non-portal accounts.
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldName, account.FieldNotes, account.FieldPlatform, account.FieldType, account.FieldStatus, account.FieldErrorMessage, account.FieldExternalProviderAccountID, account.FieldTempUnschedulableReason, account.FieldSessionWindowStatus:
	...
	for i := range columns {
		...
		case account.FieldExternalProviderAccountID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.ExternalProviderAccountID = new(string)
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	if v := _m.ExternalProviderAccountID; v != nil {
