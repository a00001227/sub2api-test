...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	providerConnectCompletionService := service.NewProviderConnectCompletionService(providerConnectSessionRepository, providerConnectAccountRepository, oAuthService, providerWebhookNotifier)
	...
	providerConnectHandler := handler.NewProviderConnectHandler(providerConnectService, providerConnectCompletionService, providerConnectImportService, proxyAllocator, providerAccountMetricsService, regionService, providerAccountDeactivationService)
